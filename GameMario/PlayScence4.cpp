...
CPlayScene4::CPlayScene4(int id, LPCWSTR filePath) :
	CScene(id, filePath)
{
	key_handler = new CPlayScence4KeyHandler(this);
}
...
void CPlayScene4::_ParseSection_MAP(string line)
{
	vector<string> tokens = split(line);
...
void CPlayScene4::_ParseSection_ITEM_OBJECTS(string line)
{
	vector<string> tokens = split(line);
...
void CPlayScene4::_ParseSection_ENEMIES(string line)
{
	vector<string> tokens = split(line);
...
void CPlayScence4KeyHandler::OnKeyDown(int KeyCode)
{
...
void CPlayScence4KeyHandler::OnKeyUp(int KeyCode)
{
	CMario* mario = ((CPlayScene4*)scence)->GetPlayer();
	switch (KeyCode)
	{
...
void CPlayScence4KeyHandler::KeyState(BYTE* states)
{
	CGame* game = CGame::GetInstance();
	CMario* mario = ((CPlayScene4*)scence)->GetPlayer();
